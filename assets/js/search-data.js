    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-three-papers-accepted-at-iros-25-in-hanghzou-sparkles-smile",
          title: 'Three papers accepted at IROS’25 in Hanghzou! :sparkles: :smile:',
          description: "",
          section: "News",},{id: "news-daniel-at-bring-it-up-podcast",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%64%61%6E%69%65%6C.%64%75%65%63%6B%65%72@%74%75%6D.%64%65", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/daniel-duecker", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-7256-6984", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=hjyu7FEAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
